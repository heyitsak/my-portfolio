...
// Travel stories data - move to data/stories.ts when you have more
const stories = [
  {
    ...
    date: 'December 2023',
    image: '/stories/mountains.jpg', // Add your image
  },
  {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {stories.map((story) => (
            ...
            >
              ...
              <h2 className="font-display text-xl font-semibold text-white group-hover:text-indigo-300 transition-colors mb-2">
                {story.title}
              </h2>
